...
DATA_WORKS_FIRST_DEFINITION = [
  ...
  {id: 'mail_actu_quotidien', every: 1.day, at:2, exec:'CJActualites.mail_quotidien', required:'actualites'},
  {id: 'mail_actu_hebdo', day:6, at:2, exec:'CJActualites.mail_hebdomadaire', required:'actualites'}
]

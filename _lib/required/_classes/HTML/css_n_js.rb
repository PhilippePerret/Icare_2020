...
CSS_JS_VERSION = '6'
CSS_TAG = '<link rel="stylesheet" type="text/css" href="%{css}?v='+CSS_JS_VERSION+'" />'
JAVASCRIPT_TAG = '<script src="%{js}?v='+CSS_JS_VERSION+'" type="text/javascript" charset="utf-8"></script>'

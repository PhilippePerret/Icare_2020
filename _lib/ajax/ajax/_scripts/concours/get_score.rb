...
begin
  ...
  # log("evaluator:#{evaluator.inspect}/ synopsis_id: #{synopsis_id.inspect} / concurrent_id: #{concurrent_id.inspect} / annee: #{annee.inspect}")
  score = {}
  if score_path && File.exists?(score_path)

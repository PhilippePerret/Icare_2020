...
DATA_OPERATIONS_ICARIENS = {
  ...
  'repare_document' => {id:'repare_document', name:'Réparer document QDD',      for: :all,      required: [:short_value], short_value: 'ID(s) du ou des documents qu’il faudrait réparer (séparé par espaces ou virgules)', cb_value: nil, description: 'Cet outil permet de réparer la marque “existant” des documents QDD qui, en réalité, n’existent pas sur le QDD mais sont pourtant marqués existant dans les options du document.'},
